...
$inputXML = (new-object Net.WebClient).DownloadString("https://raw.githubusercontent.com/DeadLaurin/essentials/main/MainWindow.xaml") #uncomment for Production
...
Function Get-FormVariables {
    ...
    write-host "███████╗███████║███████║███████╗██║ ╚████║   ██║   ██║██║  ██║███████╗███████║"
    write-host "╚══════╝╚══════╝╚══════╝╚══════╝╚═╝  ╚═══╝   ╚═╝   ╚═╝╚═╝  ╚═╝╚══════╝╚══════╝"
    write-host "====Laurin Computer Consultants====="
    write-host "=====Laurin Software Essentials====="
...
# Global Variables
#===========================================================================
$AppTitle = "Laurin Software Essentials"
...
$WPFinstall.Add_Click({
        ...
        If ( $WPFInstallcrystaldisk.IsChecked -eq $true ) { 
            $wingetinstall.Add("CrystalDewWorld.CrystalDiskInfo")
            $WPFInstallcrystaldisk.IsChecked = $false
        }
        If ( $WPFInstallcrystaldiskmark.IsChecked -eq $true ) { 
            $wingetinstall.Add("CrystalDewWorld.CrystalDiskMark")
            $WPFInstallcrystaldiskmark.IsChecked = $false
        }                          
        ...
        If ( $WPFInstalljellyplayer.IsChecked -eq $true ) { 
            $wingetinstall.Add("Jellyfin.JellyfinMediaPlayer")
            $WPFInstalljellyplayer.IsChecked = $false
        }
        If ( $WPFInstalljellyserver.IsChecked -eq $true ) { 
            $wingetinstall.Add("Jellyfin.Server")
            $WPFInstalljellyserver.IsChecked = $false
        }      
        ...
        If ( $WPFInstallmicrosoft.IsChecked -eq $true ) { 
            $wingetinstall.Add("Microsoft.Office")
            $WPFInstallmicrosoft.IsChecked = $false
        }    
        ...
        If ( $WPFInstallspeedtest.IsChecked -eq $true ) { 
            $wingetinstall.Add("Ookla.Speedtest")
            $WPFInstallspeedtest.IsChecked = $false
        }           
        ...
        If ( $WPFInstallsuperposition.IsChecked -eq $true ) { 
            $wingetinstall.Add("Unigine.SuperpositionBenchmark")
            $WPFInstallsuperposition.IsChecked = $false
        }                       
